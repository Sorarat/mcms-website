      ...
      <Navbar />
        <div className="p-5">
          ...
          <div className="md:flex md:items-start md:p-3 ">
            <div className="text-left font-light mb-10 mt-5 md:w-1/2 ">
            ...
            <div className="flex flex-col items-center mx-auto gap-y-2 w-36 md:flex-row md:mr-8 md:order-first">
              <div>
                <img
